...
export interface ApiRedirectRedirect extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    redirectFrom: Schema.Attribute.String;
...
export interface ApiSystemResourceSystemResource
  extends Struct.CollectionTypeSchema {
...
export interface ApiWebSettingWebSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    articleDetailPage: Schema.Attribute.Relation<'oneToOne', 'api::page.page'>;
    mainMenu: Schema.Attribute.Relation<'oneToOne', 'api::menu.menu'>;
    articlesPage: Schema.Attribute.Relation<'oneToOne', 'api::page.page'>;
    globalSeo: Schema.Attribute.Component<'shared.global-seo', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
